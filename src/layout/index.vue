<template>
	...
	<!-- 时空信息平台自定义 -->
	<template v-else-if="layout=='made'">
		<header class="adminui-header" style="background-color: #fff;color: #000;border-bottom: 2px solid #cccccc;">
			<div class="adminui-header-left">
				<div class="logo-bar">
					<!-- <img class="logo" src="img/cloud.png"> -->
					<img class="logo" src="img/logo.png">
					<span>{{ $CONFIG.APP_NAME }}</span>
					<!-- <span style="margin-left:10px;font-size: 22px;">熊猫时空信息平台</span> -->
				</div>
			</div>
			<div class="adminui-header-right" >
				<userbar></userbar>
		...
		<section class="aminui-wrapper">
			<div v-if="!ismobile" class="aminui-side-split">
				<div class="adminui-side-split-scroll">
					<el-scrollbar style="background: #424242;">
						<ul>
