		...
		<el-container>
				<el-header>
					<div class="left-panel">
						<el-button type="primary" icon="el-icon-plus" @click="add">创建应用</el-button>
            ...
            <el-table-column label="应用ID" prop="Id" width="240" align="center"></el-table-column>
						<!-- <el-table-column label="用户ID" prop="uid" width="200" align="center"></el-table-column>
						<el-table-column label="用户名" prop="userName" width="160" align="center"></el-table-column> -->
						<el-table-column label="应用类型" prop="applytype" width="200" align="center">
            ...
            <el-table-column label="应用名称" prop="applyname" width="260" align="center"></el-table-column>
						<el-table-column label="密钥" prop="askey" width="300" align="center"></el-table-column>
            <el-table-column label="备注" prop="remark" width="260" align="center"></el-table-column>
            <!-- <el-table-column label="创建时间" prop="createTime" width="150" align="center"></el-table-column> -->
	...
	export default {
		...
		methods: {
			...
			async table_del(row){
				...
				var res = await this.$API.system.userapply.delUserApply.post(reqData);
      ...
      handleCurrentChange(val) {
        ...
        let data = {
          token: this.$TOOL.data.get("TOKEN")
				...
				var res = await this.$API.system.userapply.getUserApply.post(data);
				if(res.resultCode == "0000"){
					this.group = res.data;
